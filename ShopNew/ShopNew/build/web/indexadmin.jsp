                    ...
                    <li>
                        ...
                        <div class="user-section">
                            <div class="user-section-inner">
                                <img src="<%=ad.getAdminImg()%>" alt="">
                            </div>
                            <div class="user-info">
                                <div><%=ad.getAdminFullName()%></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel panel-primary text-center no-boder">
                        ...
                        <div class="panel-footer">
                            <span class="panel-eyecandy-title">ĐƠN HÀNG
                            </span>
                        </div>
                    </div>
                    <div class="panel panel-primary text-center no-boder">
                    ...
                    <div class="panel panel-primary text-center no-boder">
                        <div class="panel-body red">
                            ...
                            %>
                            <h3><%=userDao.CountUsers()%></h3>
                        </div>
                        <div class="panel-footer">
                            <span class="panel-eyecandy-title">SỐ NGƯỜI ĐĂNG KÍ
                            </span>
                        </div>
                    </div>
